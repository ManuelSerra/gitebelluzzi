...
<html lang="it">
  ...
  */
    ...
    $queryClassi = "SELECT classe.PK_codice as classe FROM classe left join giteScolastica on classe.PK_codice = giteScolastica.FK_classe where giteScolastica.FK_classe IS NULL";
    ...
    $queryDocenti = "SELECT docente.PK_codice as codice, docente.nome as nome, docente.cognome as cognome FROM docente LEFT JOIN giteScolastica ON giteScolastica.FK_docente = docente.PK_codice WHERE giteScolastica.FK_docente IS NULL AND docente.isDisponibile = 1";
